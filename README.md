<sub>[![Go Reference](https://pkg.go.dev/badge/github.com/github/go-spdx/v2@v2.6.0/spdxexp.svg)](https://pkg.go.dev/github.com/github/go-spdx/v2@v2.6.0/spdxexp) spdxexp</sub> <br>
<sub>[![Go Reference](https://pkg.go.dev/badge/github.com/github/go-spdx/v2@v2.6.0/spdxexp/spdxlicenses.svg)](https://pkg.go.dev/github.com/github/go-spdx/v2@v2.6.0/spdxexp/spdxlicenses) spdxlicenses</sub>
